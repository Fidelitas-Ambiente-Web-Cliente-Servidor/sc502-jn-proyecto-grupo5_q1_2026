import { crearCuerpoApi, URL_BASE_API, verificarSesionActiva } from '../utils.js';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    btnPlaceOrder.addEventListener('click', function (e) {
        ...
        verificarSesionActiva().then(sesionActiva => {
            ...
            const metodoPago = document.querySelector('input[name="payment-method"]:checked')?.value || 'pagocontraentrega';
